...
logging.basicConfig(filename="FL2.5KNA.log", level=logging.DEBUG)

csv_path = "/home/ht65490/Desktop/SPFlow-H/src/spn/RSPMN_MDP_Datasets/FrozenLake/FL2.5.csv"
...
#Structure Learning
rspmn = RSPMNnewAlgo(partial_order, decision_nodes, utility_nodes, feature_names, meta_types, cluster_by_curr_information_set=False, util_to_bin=False)
